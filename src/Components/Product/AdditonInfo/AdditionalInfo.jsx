          ...
          <div className="productAdditionalInfoContent">
            ...
            {activeTab === "aiTab1" && (
              <div className="aiTabDescription">
                ...
                <div className="descriptionParaGrid">
                  <div className="descriptionPara">
                    <h3>Neden bu ürünü seçin?</h3>
                    <p>
                      <ul>
                        <li>Yumuşak ve yumuşak bir pamuk ile oluşturulmuştur</li>
                        <li>
                          Basit, Yapılandırılabilir (örn. boyut, renk, vb.), paketlenmiş
                        </li>
                        <li>İndirilebilir/Dijital Ürünler, Sanal Ürünler</li>
                      </ul>
                    </p>
                  </div>
                  <div className="descriptionPara">
                    <h3>Örnek Numara Listesi</h3>
                    <p>
                      <ol>
                        <li>Yumuşak ve yumuşak bir pamuk ile oluşturulmuştur</li>
                        <li>
                ...
                <div className="descriptionPara">
                  ...
                  <p style={{ marginTop: "-10px" }}>
                    100% Polyester, Ana: 100% Polyester.
                  </p>
                </div>
              </div>
            )}
            ...
            {activeTab === "aiTab2" && (
              <div className="aiTabAdditionalInfo">
                ...
                <div className="additionalInfoContainer">
                  <h6>Storage</h6>
                  <p> Konforlu uyku şortu, sağlam bir şekilde paketlenmiştir</p>
                </div>
              </div>
            )}
                ...
                <div className="aiTabReviewContainer">
                  ...
                  <div className="userReviews">
                    ...
                    >
                      ...
                      <div className="userReviewContent">
                        ...
                        >
                          <p>
                            Konforlu uyku şortu, sağlam bir şekilde paketlenmiştir
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="userNewReview">
                    <div className="userNewReviewMessage">
                      <h5>
                        İlk yorum yapan olun “Lightweight Puffer Jacket With a
                        Hood”
                      </h5>
                      <p>
                        Email adresiniz yayınlanmayacaktır. Gerekli alanlar işaretlenmiştir
                      </p>
                    </div>
                    ...
                    <div className="userNewReviewForm">
                      <form>
                        ...
                        <div className="userNewReviewFormCheck">
                          <label>
                            <input type="checkbox" placeholder="Konu" />
                            Adınız, email adresiniz ve web sitesini bu tarayıcıda kaydet
                            bir sonraki yorumumda kullan.
                          </label>
                        </div>
